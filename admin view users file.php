<html>
    ...
    <link rel ="stylesheet" type="text/css" href="newpretty.css">
	<meta charset="UTF-8">
...
?>
     <table>
              ...
              <?php
                ...
                ?>
                 <tr>
                  ...
                  <td>
                      <form method="POST" action="admin view users file.php" enctype="multipart/form-data">
                          <button name="delete" value="<?php echo $row['first_name']; ?>">Delete</button>
						  <button name="pdf" embed type="application/pdf" src="pdf/<?php echo $row['pdf'] ; ?>" width="900" height="500">
                        </form>
                  </td>
          ...
          $sql="INSERT INTO file values('$pdf')";
